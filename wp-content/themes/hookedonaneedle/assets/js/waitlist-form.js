...
class WaitlistForm {
    ...
    async handleSubmit(event) {
        ...
        try {
            const response = await this.submitForm(email);

            if (response.success) {
                this.showSuccess(response.data.message || 'Thank you! You\'ve been added to the waitlist.');
            } else {
...
// Initialize all waitlist forms when DOM is ready
